INTERIORS = {
    -- HOSPITAL
    [1] = {id = 1, x = 294.83221435547, y = -1448.4013671875, z = 29.966623306274,  name = "Salir del Hospital", destination = {2}},
	[2] = {id = 2, x = 251.32405090332, y = -1367.2664794922, z = 39.534370422363,  name = "Entrar al Hospital", destination = {1}},
