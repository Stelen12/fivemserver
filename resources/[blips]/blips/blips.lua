local blips = {
	...
	{title="Lugar de pesca", colour=68, id=28, x=743.19586181641, y=-3895.3967285156, z=30.556676864624},
	...
	{title="Transporte de dinero", color=4, id=198, x = 243.67727661133, y = 230.6535949707, z = 106.28681945801},
	{title="Club", colour=48, id=121, x=-1395.9016113281, y=-607.93939208984, z=30.319543838501},
	{title="Bar de la playa", colour=47, id=102, x=1374.25, y=-2711.89, z=2.31},
	...
	{title="Reportes policiales", colour=38, id=408, x = 439.57083129883, y = -995.072265625, z = 30.689596176147}, -- Mission Row
	{title="Reportes policiales", colour=38, id=408, x = 1851.6605224609, y = 3690.6713867188, z = 34.267044067383}, -- Sandy Shores
	{title="Reportes policiales", colour=38, id=408, x = -449.43395996094, y = 6010.796875, z = 31.716377258301}, -- Paleto
	...
	{title="Recolectar carga", colour=2, id=94, x = 1162.7274169922, y = -1477.8304443359, z = 34.842906951904}, -- Cargo
	...
	{title="Recolector de basura", colour=30, id=43, x = 807.07354736328, y = -1077.0104980469, z = 28.621067047119}, -- Trash for Trash Collector
	{title="Garage (Correo)", colour=30, id=16, x = 69.852645874023, y = 117.0472946167, z = 79.126907348633}, -- UPS Garage
	{title="Garage (UBER)", colour=30, id=16, x = 907.38049316406, y = -175.86546325684,z = 74.130157470703}, -- UBER Garage
	{title="Garage (Pescador)", colour=30, id=16, x = 1508.8854980469,y = 3908.5732421875,z = 30.031631469727}, -- Fishing Garage
	{title="Garage (Transporte medicinal)", colour=30, id=16, x = -319.82263183594, y = -942.8408203125,z = 31.080617904663}, -- Medical Weed Garage
	{title="Garage (Transporte de dinero)", colour=30, id=16, x = 222.68756103516,y = 222.95631408691,z = 105.41331481934}, -- Bank Driver Garage
	{title="Garage (Mecanico)", colour=30, id=16, x = 401.42602539063, y = -1631.7053222656,z = 29.291942596436}, -- Mechanic Garage
	{title="Garage (Delivery)", colour=30, id=16, x = 964.514770507813, y = -1020.13879394531,z = 40.8475074768066}, -- Delivery Garage
	{title="Garage (Abogado)", colour=30, id=16, x = -1900.7344970703, y = -560.89245605469, z = 11.802397727966}, -- Lawyer Garage
	{title="Centro de correo", colour=30, id=16, x = 76.495727539063,y = -27.030916213989,z = 68.562599182129} -- UPS Parcel collection point
  }
