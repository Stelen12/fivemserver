...
cfg.items = {
  ["benzoilmetilecgonina"] = {"Benzoilmetilecgonina", "Un Benzoic acid ester.", nil, 0.01}, -- no choices
  ["seeds"] = {"Seeds", "Semillas de marihuana.", nil, 0.01}, -- no choices
  ...
  ["trash"] = {"Basura", "Huele a mierda..", nil, 0.04},  -- no choices
