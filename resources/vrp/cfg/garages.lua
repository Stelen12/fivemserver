...
cfg.garage_types = {
  ...
  ["Exotic Cars"] = {
    ...
    ["i8"] = {"BMW I8",1000000, ""},
    ["bugatti"] = {"Bugatti Veyron",1000000, ""},
    ...
    ["bati"] = {"Ducati",1000000, ""},
    ["aaq4"] = {"Audi A4",500000, ""},
    ["sesto"] = {"Lamborgini Sesto",1000000, ""},
    ["prairie"] = {"Volkswagen Scirocco",1000000, ""},
    ["208"] = {"Peugeot 208",1000000, ""},
    ["lp700r"] = {"Lamborgini Aventador",1000000, ""},
    ["m2f22"] = {"Bmw M2",1000000, ""},
    ["bmci"] = {"Bmw M5",1000000, ""},
    ["elegy"] = {"Volkswagen Bora",1000000, ""},
    ["ccss16"] = {"Camaro",1000000, ""},
    ["pct18"] = {"Porsche Cayenne",1000000, ""},
    ["clio"] = {"Renault Clio",1000000, ""},
    ["focusrs"] = {"Ford Focus",1000000, ""},
    ["blista"] = {"Volkswagen Fox",1000000, ""},
    ["fusca"] = {"Volkswagen Fusca",1000000, ""},
    ["golf6"] = {"Volkswagen Golf MK6",1000000, ""},
    ["golf7"] = {"Volkswagen Golf MK7",1000000, ""},
    ["gtr"] = {"Nissan Gtr",1000000, ""},
    ["daemon"] = {"Harley Davidson",1000000, ""},
    ["biz25"] = {"Gilera",1000000, ""},
    ["patriot"] = {"Hummer",1000000, ""},
    ["demonhawk"] = {"Jeep Grand Cherokee",1000000, ""},
    ["kangoo"] = {"Renault Kangoo",1000000, ""},
    ["rc"] = {"KTM",1000000, ""},
    ["manana"] = {"Chevy Tunning",1000000, ""},
    ["amggt"] = {"Mercedes Benz Amg",1000000, ""},
    ["dominator"] = {"Ford Mustang",1000000, ""},
    ["huayrar"] = {"Pagani Huayra",1000000, ""},
    ["panigale"] = {"Ducati Panigale",1000000, ""},
...
cfg.garages = {
  ...
  {"Exotic Cars",216.27360534668,-788.30706787109,30.822975158691},
