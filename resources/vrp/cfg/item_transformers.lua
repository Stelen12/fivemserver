 ...
 -- },
  {
    ...
    recipes = {
      ["cocaine"] = { -- action name
        description="Hacer cocaina", -- action description
        in_money=0, -- money taken per unit
        out_money=0, -- money earned per unit
        reagents={ -- items taken per unit
      ...
      ["weed"] = { -- action name
        description="Hacer Marihuana", -- action description
        in_money=0, -- money taken per unit
        out_money=0, -- money earned per unit
        reagents={ -- items taken per unit
          ["seeds"] = 1
      ...
      ["lsd"] = { -- action name
          description="Hacer LSD", -- action description
          in_money=0, -- money taken per unit
          out_money=0, -- money earned per unit
          reagents={ -- items taken per unit
            ["harness"] = 1
...
cfg.hidden_transformers = {
  ["weed field"] = {
    def = {
      name="Obtener semillas", -- menu name
      ...
      recipes = {
        ["Harvest"] = { -- action name
          description="Cultivar semillas de marihuana.", -- action description
          in_money=0, -- money taken per unit
          out_money=0, -- money earned per unit
          reagents={}, -- items taken per unit
          products={ -- items given per unit
  ...
  ["cocaine dealer"] = {
    def = {
      ...
      recipes = {
        ["Harvest"] = { -- action name
          description="Obtener componentes para Cocaina", -- action description
          in_money=0, -- money taken per unit
          out_money=0, -- money earned per unit
          reagents={}, -- items taken per unit
          products={ -- items given per unit
  ...
  ["lsd bar"] = {
    def = {
      ...
      recipes = {
        ["Harvest"] = { -- action name
          description="Negociando componentes para LSD", -- action description
          in_money=0, -- money taken per unit
          out_money=0, -- money earned per unit
          reagents={}, -- items taken per unit
          products={ -- items given per unit
