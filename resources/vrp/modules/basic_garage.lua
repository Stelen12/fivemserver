...
for group,vehicles in pairs(vehicle_groups) do
  ...
  if group == 'agente' or group == 'cabo' or group == 'cabo primero' or group == 'sargento' or group == 'sargento primero' or group == 'comisario' or group == 'Police Helicopters' or group == 'aspirante' or group == 'doctor' or group == 'cirujano' or group == 'coordinador' or group == 'jefe de zona' or group == 'Novato' or group == 'Experimentado' or group == 'Subjefe' or group == 'delivery' or group == 'Bote de pescador' or group == 'Piloto de carga' or group == 'uber' or group == 'Correo' or group == 'Transportista de dinero' or group == 'Recolector de basura' or group == 'Transporte medicinal' then --Verificando garage
