local cfg = {}
cfg.list = {
  [1] = { offset = -1.2, mystatus = true, hash = 1557126584, x = 449.69815063477, y = -986.46911621094, z = 30.689594268799, locked = true, key = "key_lspd", permission="police.pc", name = "LSPD"},
  [2] = { offset = -1.2, mystatus = true, hash = 749848321, x = 452.61877441406, y = -982.7021484375, z = 30.689598083496, locked = true, key = "key_lspd", permission="police.pc", name = "LSPD"},
  [3] = { offset = -1.2, mystatus = false, hash = -1320876379, x = 447.23818969727, y = -980.63006591797, z = 30.689598083496, locked = true, key = "key_pd_boss", permission="boss_lspd.pc", name = "LSPD"},
